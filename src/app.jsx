...
function App() {
  ...
  useEffect(()=>{
    ...
    fetch("https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=25&key=AIzaSyCo6dwKiTc_1_R-y6QwJSUu2of3E03oXQs", requestOptions)
